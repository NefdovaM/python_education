...
prod_of_numbers = int(input('Введите произведение чисел: '))
from math import sqrt
root = sqrt((sum_of_numbers/2)**2 - prod_of_numbers)
print(int(sum_of_numbers/2 - root), int(sum_of_numbers/2 + root))